  ...
  return (
    <div className="grid min-h-screen grid-rows-[20px_1fr_20px] items-center justify-items-center gap-16 p-8 pb-20 font-[family-name:var(--font-geist-sans)] sm:p-20">
      <main className="row-start-2 flex flex-col items-center gap-8 sm:items-start">
        <button className="primary_button" onClick={onclickLogout}>
          Logout
        </button>
        <Image
        ...
        <ol className="list-inside list-decimal text-center font-[family-name:var(--font-geist-mono)] text-sm sm:text-left">
          ...
          <li>Girl, you’re amazing just the way you are</li>
        </ol>

        <div className="hidden flex-col items-center gap-4 sm:flex-row">
          <a
      ...
      <footer className="row-start-3 hidden flex-wrap items-center justify-center gap-6">
        <a
